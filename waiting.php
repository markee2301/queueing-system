...
$sql = "SELECT * FROM queue_list WHERE status = 'WAITING' ORDER BY priority ASC";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <form id="update_form" method="post" action="waiting_update.php" onsubmit="return confirm('\nAre you sure you want to UPDATE STATUS?');">
            ...
            <td>
                <form id="update_form" method="post" action="waiting_delete.php" onsubmit="return confirm('\nAre you sure you want to DELETE this item?');">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
