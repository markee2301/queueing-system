...
$sql = "SELECT * FROM queue_list WHERE priority = 1 && status = 'PROCESSING' || priority = 1 && status = 'READY' || priority = 1 && status = 'ONCALL' ORDER BY CASE status WHEN 'READY' THEN 1 WHEN 'ONCALL' THEN 2 WHEN 'PROCESSING' THEN 3 ELSE 4 END, priority ASC";
...
<body>
    ...
    <h1>PRIORITY 1 (RETURNING PWD)</h1>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <form id="update_form"method="post" action="priority1_delete.php" onsubmit="return confirm('\nAre you sure you want to DELETE this item?');">
