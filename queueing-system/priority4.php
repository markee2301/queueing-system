...
$sql = "SELECT * FROM queue_list WHERE priority = 4 && status = 'WAITING' || priority = 4 && status = 'READY' || priority = 4 && status = 'ONCALL' || priority = 4 && status = 'PROCESSING' ORDER BY CASE status WHEN 'READY' THEN 1 WHEN 'ONCALL' THEN 2 WHEN 'PROCESSING' THEN 3 ELSE 4 END, priority ASC";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <form id="update_form" method="post" action="priority4_update.php" onsubmit="return confirm('\nAre you sure you want to update the PRIORITY to 3?');">
            ...
            <td>
                <form id="update_form" method="post" action="priority4_delete.php" onsubmit="return confirm('\nAre you sure you want to DELETE this item?');">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
