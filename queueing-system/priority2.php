...
$sql = "SELECT * FROM queue_list WHERE priority = 2 && status = 'WAITING' || priority = 2 && status = 'READY' || priority = 2 && status = 'ONCALL' || priority = 2 && status = 'PROCESSING' ORDER BY CASE status WHEN 'READY' THEN 1 WHEN 'ONCALL' THEN 2 WHEN 'PROCESSING' THEN 3 ELSE 4 END, priority ASC";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <form id="update_form" method="post" action="priority2_update.php" onsubmit="return confirm('\nAre you sure you want to update the PRIORITY to 1?');">
            ...
            <td>
                <form id="update_form" method="post" action="priority2_delete.php" onsubmit="return confirm('\nAre you sure you want to DELETE this item?');">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
