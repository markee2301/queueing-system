...
$sql = "SELECT * FROM queue_list WHERE status = 'READY' ORDER BY priority ASC";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <form id="update_form" method="post" action="ready_update.php" onsubmit="return confirm('\nCurrent status is READY.\nAre you sure you want to UPDATE?');">
            ...
            <td>
                <form id="update_form" method="post" action="ready_delete.php" onsubmit="return confirm('\nAre you sure you want to DELETE this item?');">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
